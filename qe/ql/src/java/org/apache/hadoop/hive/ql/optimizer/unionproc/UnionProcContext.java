...
public class UnionProcContext implements NodeProcessorCtx {
  ...
  public static class UnionParseContext {
    ...
    transient private boolean issetTaskPlan;

    public boolean isIssetTaskPlan() {
      return issetTaskPlan;
    }

    public void setIssetTaskPlan(boolean issetTaskPlan) {
      this.issetTaskPlan = issetTaskPlan;
    }

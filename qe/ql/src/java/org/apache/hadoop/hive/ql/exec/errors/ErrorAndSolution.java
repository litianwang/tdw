...
public class ErrorAndSolution {
  ...
  public boolean equals(Object o) {
    ...
    if (e.error != null && this.error != null) {
      if (!e.error.equals(this.error)) {
        return false;
      }
    } else if (e.error != null || this.error != null) {
      return false;
    }

    if (e.solution != null && this.solution != null) {
      if (!e.solution.equals(this.solution)) {
        return false;
      }
    } else if (e.solution != null || this.solution != null) {
      return false;
    }

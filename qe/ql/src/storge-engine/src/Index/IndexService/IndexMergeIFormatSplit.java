...
public class IndexMergeIFormatSplit implements InputSplit {
  public static final Log LOG = LogFactory.getLog(IndexMergeIFormatSplit.class);
  ...
  public IndexMergeIFormatSplit() {
  }

  public IndexMergeIFormatSplit(Path filename, long length, int beginline,
  ...
  public IndexMergeIFormatSplit(Path filename, long length,
  ...
  public IndexMergeIFormatSplit(Path filename, long length, String[] hosts) {
    this.file = filename;
    this.hosts = hosts;
    this.length = length;
    this.splitbyline = true;

...
public class OperatorFactory {
  ...
  static {
    ...
    opvec.add(new opTuple<partitionSinkDesc>(partitionSinkDesc.class,
        PartitionerOperator.class));
    opvec
    ...
    opvec.add(new opTuple<uniqueDesc>(uniqueDesc.class, UniqueOperator.class));
    opvec.add(new opTuple<LateralViewForwardDesc>(LateralViewForwardDesc.class,
        LateralViewForwardOperator.class));

    opvec.add(new opTuple<statsDesc>(statsDesc.class,
        StatsCollectionOperator.class));
    opvec.add(new opTuple<histogramDesc>(histogramDesc.class,
        HistogramOperator.class));
    opvec.add(new opTuple<sampleDesc>(sampleDesc.class, SampleOperator.class));

    opvec.add(new opTuple<halfSortLimitDesc>(halfSortLimitDesc.class,
        HalfSortLimitOperator.class));

    opvec.add(new opTuple<analysisDesc>(analysisDesc.class,
        AnalysisOperator.class));
    ...
    opvec.add(new opTuple<rowExtendDesc>(rowExtendDesc.class,
        RowExtendOperator.class));

    opvec.add(new opTuple<LocalFileSinkDesc>(LocalFileSinkDesc.class,
        LocalFileSinkOperator.class));
    opvec.add(new opTuple<LocalSelectDesc>(LocalSelectDesc.class,
        LocalSelectOperator.class));
  }

...
public class Sample {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof Sample) {
      Sample s = (Sample) o;
      return ((this.sampleNum == s.sampleNum)
          && (this.sampleFraction == s.sampleFraction) && this.sampleDimension
  ...
  public String toString() {
    return this.sampleNum + "/" + this.sampleFraction + "@("
  ...
  public int hashCode() {
    ...
    result = prime
        * result
        + ((this.sampleDimension == null) ? 0 : this.sampleDimension.hashCode());

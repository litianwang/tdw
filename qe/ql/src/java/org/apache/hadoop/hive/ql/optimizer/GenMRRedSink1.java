...
public class GenMRRedSink1 implements NodeProcessor {
  ...
  public Object process(Node nd, Stack<Node> stack, NodeProcessorCtx opProcCtx,
    ...
    Map<Operator<? extends Serializable>, GenMapRedCtx> mapCurrCtx = ctx
        .getMapCurrCtx();
    GenMapRedCtx mapredCtx = mapCurrCtx
        .get((Operator<? extends Serializable>) stack.get(stack.size() - 2));
    ...
    currPlan.distinctNum = op.getConf().getDistinctColumnIndices() != null ? op
        .getConf().getDistinctColumnIndices().size() : 0;
    currPlan.reduceFactor = op.getConf().getReduceNumFactor();

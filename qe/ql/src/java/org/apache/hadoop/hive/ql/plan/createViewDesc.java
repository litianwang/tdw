...
public class createViewDesc implements Serializable {
  ...
  private List<String> vtables;

  public void addVTable(String table_name) {
    if (vtables.contains(table_name))
      return;
    vtables.add(table_name);
  }

  public List<String> getVtables() {
  ...
  public createViewDesc(String viewName, List<FieldSchema> schema,
    ...
    this.vtables = new ArrayList<String>();
  }

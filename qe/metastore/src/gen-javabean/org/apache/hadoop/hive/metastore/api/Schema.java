...
public class Schema implements org.apache.thrift.TBase<Schema, Schema._Fields>,
    java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
      "Schema");

  private static final org.apache.thrift.protocol.TField FIELD_SCHEMAS_FIELD_DESC = new org.apache.thrift.protocol.TField(
      "fieldSchemas", org.apache.thrift.protocol.TType.LIST, (short) 1);
  private static final org.apache.thrift.protocol.TField PROPERTIES_FIELD_DESC = new org.apache.thrift.protocol.TField(
      "properties", org.apache.thrift.protocol.TType.MAP, (short) 2);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    FIELD_SCHEMAS((short) 1, "fieldSchemas"), PROPERTIES((short) 2,
        "properties");
  ...
  static {
    Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
        _Fields.class);
    tmpMap
        .put(_Fields.FIELD_SCHEMAS,
            new org.apache.thrift.meta_data.FieldMetaData("fieldSchemas",
                ...
                new org.apache.thrift.meta_data.ListMetaData(
                    ...
                    new org.apache.thrift.meta_data.StructMetaData(
                        ...
                        FieldSchema.class))));
    tmpMap.put(_Fields.PROPERTIES,
        new org.apache.thrift.meta_data.FieldMetaData("properties",
            org.apache.thrift.TFieldRequirementType.DEFAULT,
  ...
  public Schema(Schema other) {
    ...
    if (other.isSetProperties()) {
      ...
      for (Map.Entry<String, String> other_element : other.properties
          .entrySet()) {
  ...
  public int compareTo(Schema other) {
    ...
    lastComparison = Boolean.valueOf(isSetFieldSchemas()).compareTo(
        typedOther.isSetFieldSchemas());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFieldSchemas()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(
          this.fieldSchemas, typedOther.fieldSchemas);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetProperties()).compareTo(
        typedOther.isSetProperties());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetProperties()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.properties,
          typedOther.properties);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class SchemaStandardScheme extends StandardScheme<Schema> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Schema struct)
        throws org.apache.thrift.TException {
          ...
          if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              struct.fieldSchemas = new ArrayList<FieldSchema>(_list88.size);
              for (int _i89 = 0; _i89 < _list88.size; ++_i89) {
                FieldSchema _elem90;
                _elem90 = new FieldSchema();
                _elem90.read(iprot);
                struct.fieldSchemas.add(_elem90);
              }
              iprot.readListEnd();
            }
          ...
          if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              struct.properties = new HashMap<String, String>(2 * _map91.size);
              for (int _i92 = 0; _i92 < _map91.size; ++_i92) {
                String _key93;
                String _val94;
                _key93 = iprot.readString();
                _val94 = iprot.readString();
                struct.properties.put(_key93, _val94);
              }
              iprot.readMapEnd();
            }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Schema struct)
        throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.fieldSchemas != null) {
        oprot.writeFieldBegin(FIELD_SCHEMAS_FIELD_DESC);
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(
              org.apache.thrift.protocol.TType.STRUCT, struct.fieldSchemas
                  .size()));
          for (FieldSchema _iter95 : struct.fieldSchemas) {
            _iter95.write(oprot);
          }
          oprot.writeListEnd();
        }
        ...
        oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
        {
          oprot
              .writeMapBegin(new org.apache.thrift.protocol.TMap(
                  org.apache.thrift.protocol.TType.STRING,
                  org.apache.thrift.protocol.TType.STRING, struct.properties
                      .size()));
          for (Map.Entry<String, String> _iter96 : struct.properties.entrySet()) {
  ...
  private static class SchemaTupleScheme extends TupleScheme<Schema> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Schema struct)
        throws org.apache.thrift.TException {
      ...
      if (struct.isSetFieldSchemas()) {
        {
          ...
          for (FieldSchema _iter97 : struct.fieldSchemas) {
            _iter97.write(oprot);
          }
        }
      }
      if (struct.isSetProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter98 : struct.properties.entrySet()) {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Schema struct)
        throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fieldSchemas = new ArrayList<FieldSchema>(_list99.size);
          for (int _i100 = 0; _i100 < _list99.size; ++_i100) {
            FieldSchema _elem101;
            _elem101 = new FieldSchema();
            _elem101.read(iprot);
            struct.fieldSchemas.add(_elem101);
          }
        }
        struct.setFieldSchemasIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map102 = new org.apache.thrift.protocol.TMap(
              org.apache.thrift.protocol.TType.STRING,

...
public class GBKIgnoreKeyOutputFormat<K extends WritableComparable, V extends Writable>
    extends GBKOutputFormat<K, V> implements HiveOutputFormat<K, V> {
    ...
    return new RecordWriter() {
      public void write(Writable r) throws IOException {
        if (r instanceof Text) {
          Text tr = (Text) r;
          outStream.write(tr.toString().getBytes("gbk"));

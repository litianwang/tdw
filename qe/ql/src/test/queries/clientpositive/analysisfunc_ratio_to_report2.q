...
SELECT * FROM (SELECT int_data1 , int_data2, boolean_data, double_data, string_data, RATIO_TO_REPORT(int_data2) OVER(partition by boolean_data) FROM nulltest) tmp ORDER BY double_data, string_data;

SELECT * FROM ( SELECT int_data1 , int_data2, boolean_data, double_data, string_data, RATIO_TO_REPORT(double_data) OVER(partition by int_data1) FROM nulltest) tmp ORDER BY double_data, string_data;

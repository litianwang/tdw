  ...
  public void testExprNodeConversionEvaluator() throws Throwable {
    try {
      ...
      assertEquals(Double.valueOf("1"),
          ObjectInspectorUtils.copyToStandardObject(resultO, resultOI,
          ...
          ExprNodeEvaluatorFactory
              .get(TypeCheckProcFactory.DefaultExprProcessor
                  .getFuncExprNodeDesc("-",
                      ...
                      new exprNodeConstantDesc(3))), r,
          Integer.valueOf(1 + 2 - 3));
      measureSpeed("1 + 2 - 3 + 4", basetimes * 100,
          ExprNodeEvaluatorFactory
              .get(TypeCheckProcFactory.DefaultExprProcessor
                  .getFuncExprNodeDesc("+",
                      TypeCheckProcFactory.DefaultExprProcessor
      ...
      measureSpeed("concat(col1[1], cola[1])", basetimes * 10,
          ExprNodeEvaluatorFactory
              .get(TypeCheckProcFactory.DefaultExprProcessor
                  .getFuncExprNodeDesc(
                      "concat",
                      getListIndexNode(new exprNodeColumnDesc(col1Type, "col1",
                          "", false), constant1),
                      getListIndexNode(new exprNodeColumnDesc(colaType, "cola",
                          "", false), constant1))), r, "1b");
                      ...
                      TypeCheckProcFactory.DefaultExprProcessor
                          .getFuncExprNodeDesc(
                              ...
                              getListIndexNode(new exprNodeColumnDesc(col1Type,
                                  "col1", "", false), constant1),
                              getListIndexNode(new exprNodeColumnDesc(colaType,
                                  "cola", "", false), constant1)),
                      getListIndexNode(new exprNodeColumnDesc(col1Type, "col1",
                          "", false), constant2))), r, "1b2");
      measureSpeed(

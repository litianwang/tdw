...
public class GenericUDFFromUtcTimestamp extends GenericUDF {
  ...
  public ObjectInspector initialize(ObjectInspector[] arguments)
    ...
    if (arguments.length < 2) {
      throw new UDFArgumentLengthException("The function " + getName()
          + " requires at least two " + "argument, got " + arguments.length);
    }
    try {
      ...
      throw new UDFArgumentException("The function " + getName()
          + " takes only primitive types");
    }
  ...
  public Object evaluate(DeferredObject[] arguments) throws HiveException {
    ...
    if (timezone == null) {
      throw new HiveException("timezone is null");
    }

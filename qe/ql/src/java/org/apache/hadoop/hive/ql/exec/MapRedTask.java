  ...
  public int execute() {
    ...
    try {
      ...
      if (SessionState.get() != null)
        SessionState.get().ssLog("Generating plan file " + planFile.toString());
      ...
      if (SessionState.get() != null)
        SessionState.get().ssLog("Executing: " + cmdLine);
      ...
      if (exitVal != 0) {
        ...
        if (SessionState.get() != null)
          SessionState.get().ssLog(
              "Execution failed with exit status: " + exitVal);
      } else {
        LOG.info("Execution completed successfully");
        if (SessionState.get() != null)
          SessionState.get().ssLog("Execution completed successfully");
      }
      ...
      if (SessionState.get() != null)
        SessionState.get().ssLog("Exception: " + e.getMessage());
      return (1);
    }
  }

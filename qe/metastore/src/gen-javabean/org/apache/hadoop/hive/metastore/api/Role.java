...
public class Role implements org.apache.thrift.TBase<Role, Role._Fields>,
  ...
  private static final org.apache.thrift.protocol.TField ROLE_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField(
      "roleName", org.apache.thrift.protocol.TType.STRING, (short) 1);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ROLE_NAME((short) 1, "roleName"), PLAY_ROLES((short) 2, "playRoles"), SELECT_PRIV(
  ...
  static {
    Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
        _Fields.class);
    tmpMap.put(_Fields.ROLE_NAME,
        new org.apache.thrift.meta_data.FieldMetaData("roleName",
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Role.class,
        metaDataMap);
  }
  ...
  public Role(String roleName, List<String> playRoles, boolean selectPriv,
  ...
  public int compareTo(Role other) {
    ...
    lastComparison = Boolean.valueOf(isSetRoleName()).compareTo(
        typedOther.isSetRoleName());
    if (lastComparison != 0) {
  ...
  private static class RoleStandardScheme extends StandardScheme<Role> {
          ...
          if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              struct.playRoles = new ArrayList<String>(_list114.size);
              for (int _i115 = 0; _i115 < _list114.size; ++_i115) {
                String _elem116;
                _elem116 = iprot.readString();
                struct.playRoles.add(_elem116);
              }
              iprot.readListEnd();
            }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Role struct)
        throws org.apache.thrift.TException {
      struct.validate();
          ...
          oprot
              .writeListBegin(new org.apache.thrift.protocol.TList(
                  org.apache.thrift.protocol.TType.STRING, struct.playRoles
                      .size()));
          for (String _iter117 : struct.playRoles) {
  ...
  private static class RoleTupleScheme extends TupleScheme<Role> {
      ...
      if (struct.isSetPlayRoles()) {
        {
          ...
          for (String _iter118 : struct.playRoles) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Role struct)
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list119 = new org.apache.thrift.protocol.TList(
              org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.playRoles = new ArrayList<String>(_list119.size);
          for (int _i120 = 0; _i120 < _list119.size; ++_i120) {
            String _elem121;
            _elem121 = iprot.readString();
            struct.playRoles.add(_elem121);
          }
        }
        struct.setPlayRolesIsSet(true);
      }

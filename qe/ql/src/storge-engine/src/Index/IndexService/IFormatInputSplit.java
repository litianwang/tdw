...
public class IFormatInputSplit extends FileSplit implements InputSplit {
  public static final Log LOG = LogFactory.getLog(IFormatInputSplit.class);
  ...
  public IFormatInputSplit() {
    super((Path) null, 0, 0, (String[]) null);
  }

  public IFormatInputSplit(Path filename, long length, int beginline,
  ...
  public IFormatInputSplit(Path filename, long length, String[] hosts) {
  ...
  public IFormatInputSplit(Path filename, long length,

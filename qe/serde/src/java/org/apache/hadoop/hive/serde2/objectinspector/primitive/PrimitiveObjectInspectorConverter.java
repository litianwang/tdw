...
public class PrimitiveObjectInspectorConverter {
    ...
    public Object convert(Object input) {
      ...
      try {
        return outputOI.set(r,
            PrimitiveObjectInspectorUtils.getBoolean(input, inputOI));
  ...
  public static class TimestampConverter implements Converter {
    ...
    public Object convert(Object input) {
      ...
      return outputOI.set(r,
          PrimitiveObjectInspectorUtils.getTimestamp(input, inputOI));
    }
  }
  ...
  public static class ByteConverter implements Converter {
    ...
    public Object convert(Object input) {
      ...
      try {
        return outputOI.set(r,
            PrimitiveObjectInspectorUtils.getByte(input, inputOI));
      } catch (NumberFormatException e) {
        return null;
      }
    }
  ...
  public static class ShortConverter implements Converter {
    ...
    public Object convert(Object input) {
      ...
      try {
        return outputOI.set(r,
            PrimitiveObjectInspectorUtils.getShort(input, inputOI));
      } catch (NumberFormatException e) {
        return null;
      }
    }
  ...
  public static class IntConverter implements Converter {
    ...
    public Object convert(Object input) {
      ...
      try {
        return outputOI.set(r,
            PrimitiveObjectInspectorUtils.getInt(input, inputOI));
      } catch (NumberFormatException e) {
        return null;
      }
    }
  ...
  public static class LongConverter implements Converter {
    ...
    public Object convert(Object input) {
      ...
      try {
        return outputOI.set(r,
            PrimitiveObjectInspectorUtils.getLong(input, inputOI));
      } catch (NumberFormatException e) {
        return null;
      }
    }
  ...
  public static class FloatConverter implements Converter {
    ...
    public Object convert(Object input) {
      ...
      try {
        return outputOI.set(r,
            PrimitiveObjectInspectorUtils.getFloat(input, inputOI));
      } catch (NumberFormatException e) {
        return null;
      }
    }
  ...
  public static class DoubleConverter implements Converter {
    ...
    public Object convert(Object input) {
      ...
      try {
        return outputOI.set(r,
            PrimitiveObjectInspectorUtils.getDouble(input, inputOI));
      } catch (NumberFormatException e) {
        return null;
      }
    }
  ...
  public static class TextConverter implements Converter {
    ...
    public Text convert(Object input) {
      ...
      case BYTE:
        out.reset();
        LazyInteger.writeUTF8NoException(out,
            ((ByteObjectInspector) inputOI).get(input));
        t.set(out.getData(), 0, out.getCount());
        return t;
      case SHORT:
        out.reset();
        LazyInteger.writeUTF8NoException(out,
            ((ShortObjectInspector) inputOI).get(input));
        t.set(out.getData(), 0, out.getCount());
        return t;
      case INT:
        out.reset();
        LazyInteger.writeUTF8NoException(out,
            ((IntObjectInspector) inputOI).get(input));
        t.set(out.getData(), 0, out.getCount());
        return t;
      case LONG:
        out.reset();
        LazyLong.writeUTF8NoException(out,
            ((LongObjectInspector) inputOI).get(input));
        t.set(out.getData(), 0, out.getCount());
        return t;
      case FLOAT:
      ...
      case STRING:
        ...
        return t;
      case TIMESTAMP:
        t.set(((TimestampObjectInspector) inputOI).getPrimitiveWritableObject(
            input).toString());
        return t;
      default:

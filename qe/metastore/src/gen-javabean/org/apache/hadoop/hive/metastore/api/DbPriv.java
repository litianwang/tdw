...
public class DbPriv implements org.apache.thrift.TBase<DbPriv, DbPriv._Fields>,
  ...
  static {
    schemes.put(StandardScheme.class, new DbPrivStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DbPrivTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    DB((short) 1, "db"), USER((short) 2, "user"), SELECT_PRIV((short) 3,
        "selectPriv"), INSERT_PRIV((short) 4, "insertPriv"), INDEX_PRIV(
        ...
        (short) 11, "createviewPriv"), SHOWVIEW_PRIV((short) 12, "showviewPriv");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
        DbPriv.class, metaDataMap);
  }

  public DbPriv() {
  }

  public DbPriv(String db, String user, boolean selectPriv, boolean insertPriv,
      boolean indexPriv, boolean createPriv, boolean dropPriv,
      boolean deletePriv, boolean alterPriv, boolean updatePriv,
      boolean createviewPriv, boolean showviewPriv) {
    this();
    this.db = db;
    this.user = user;
  ...
  public int compareTo(DbPriv other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    DbPriv typedOther = (DbPriv) other;
  ...
  private static class DbPrivStandardSchemeFactory implements SchemeFactory {
    public DbPrivStandardScheme getScheme() {
      return new DbPrivStandardScheme();
    }
  }

  private static class DbPrivStandardScheme extends StandardScheme<DbPriv> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DbPriv struct)
        throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DbPriv struct)
        throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DbPrivTupleSchemeFactory implements SchemeFactory {
    public DbPrivTupleScheme getScheme() {
      return new DbPrivTupleScheme();
    }
  }

  private static class DbPrivTupleScheme extends TupleScheme<DbPriv> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DbPriv struct)
        throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DbPriv struct)
        throws org.apache.thrift.TException {

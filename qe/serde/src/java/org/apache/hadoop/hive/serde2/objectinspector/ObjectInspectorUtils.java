...
public class ObjectInspectorUtils {
  ...
  public static ObjectInspector getStandardObjectInspector(ObjectInspector oi,
    ...
    case LIST: {
      ...
      result = ObjectInspectorFactory
          .getStandardListObjectInspector(getStandardObjectInspector(
    ...
    case BYTEARRAY:
    {
      return ObjectInspectorFactory.getStandardByteArrayObjectInspector();
    }
    ...
    case STRUCT: {
      ...
      for (StructField f : fields) {
        ...
        fieldObjectInspectors.add(getStandardObjectInspector(
  ...
  public static Object copyToStandardObject(Object o, ObjectInspector oi,
    ...
    case LIST: {
      ...
      for (int i = 0; i < length; i++) {
        list.add(copyToStandardObject(loi.getListElement(o, i),
            loi.getListElementObjectInspector(), objectInspectorOption));
      }
      result = list;
      break;
    ...
    case MAP: {
      ...
      for (Map.Entry<? extends Object, ? extends Object> entry : omap
          .entrySet()) {
        map.put(
            copyToStandardObject(entry.getKey(),
                moi.getMapKeyObjectInspector(), objectInspectorOption),
            copyToStandardObject(entry.getValue(),
    ...
    case STRUCT: {
      ...
      for (StructField f : fields) {
        struct.add(copyToStandardObject(soi.getStructFieldData(o, f),
            f.getFieldObjectInspector(), objectInspectorOption));
      }
      result = struct;
      break;
    ...
    case UNION: {
      ...
      Object object = copyToStandardObject(uoi.getField(o),
          objectInspectors.get(uoi.getTag(o)), objectInspectorOption);
      result = object;
      break;
    }
  ...
  public static int hashCode(Object o, ObjectInspector objIns) {
    ...
    case UNION: {
      int tag = 0;
      Object data = null;
      if (o instanceof StandardUnion) {
        UnionObject uo = ((UnionObject) o);
        tag = uo.getTag();
        data = uo.getObject();
      } else if (o instanceof LazyUnion) {
        LazyUnion lu = ((LazyUnion) o);
        data = lu.getField();
      }
      return tag
          * 31
          + hashCode(data, ((UnionObjectInspector) objIns)
              .getObjectInspectors().get(tag));
    }
    case STRUCT: {
      int r = 0;
      StructObjectInspector soj = ((StructObjectInspector) objIns);
      List<? extends StructField> allfields = soj.getAllStructFieldRefs();
      for (StructField sf : allfields) {
        Object so = soj.getStructFieldData(o, sf);
        r = r * 31 + hashCode(so, sf.getFieldObjectInspector());
      }
      return r;
    }
    case LIST:
  ...
  public static int compare(Object o1, ObjectInspector oi1, Object o2,
    ...
    case LIST: {
      ...
      for (int i = 0; i < minimum; i++) {
        int r = compare(loi1.getListElement(o1, i),
            loi1.getListElementObjectInspector(), loi2.getListElement(o2, i),
    ...
    case UNION: {
      ...
      return compare(uoi1.getField(o1), uoi1.getObjectInspectors().get(tag1),
  ...
  public static boolean compareTypes(ObjectInspector o1, ObjectInspector o2) {
    ...
    if (c1.equals(Category.LIST)) {
      ObjectInspector child1 = ((ListObjectInspector) o1)
          .getListElementObjectInspector();
      ObjectInspector child2 = ((ListObjectInspector) o2)
          .getListElementObjectInspector();
    ...
    if (c1.equals(Category.STRUCT)) {
      ...
      List<? extends StructField> childFieldsList1 = structOI1
          .getAllStructFieldRefs();
      List<? extends StructField> childFieldsList2 = structOI2
          .getAllStructFieldRefs();

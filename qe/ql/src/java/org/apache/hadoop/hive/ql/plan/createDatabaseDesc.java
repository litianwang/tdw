...
public class createDatabaseDesc extends ddlDesc implements Serializable {
  ...
  private String hdfsschema = null;
  ...
  public void setDBStore(String db) {
    dbStore = db;
  }

  public String getHdfsschema() {
    return hdfsschema;
  }

  public void setHdfsschema(String hdfsschema) {
    this.hdfsschema = hdfsschema;
  }

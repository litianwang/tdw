...
public abstract class GenericUDFBaseCompare extends GenericUDF {
  ...
  public ObjectInspector initialize(ObjectInspector[] arguments)
    ...
    if (TypeInfoUtils.getTypeInfoFromObjectInspector(arguments[0]).equals(
    ...
    } else if (TypeInfoUtils.getTypeInfoFromObjectInspector(arguments[0])
      ...
      loi1 = (LongObjectInspector) arguments[1];
        ...
        .equals(TypeInfoFactory.byteTypeInfo)
        && TypeInfoUtils.getTypeInfoFromObjectInspector(arguments[1]).equals(
      ...
      byoi1 = (ByteObjectInspector) arguments[1];
        ...
        .equals(TypeInfoFactory.booleanTypeInfo)
        && TypeInfoUtils.getTypeInfoFromObjectInspector(arguments[1]).equals(
      ...
      TypeInfo oiTypeInfo0 = TypeInfoUtils
          .getTypeInfoFromObjectInspector(arguments[0]);
      TypeInfo oiTypeInfo1 = TypeInfoUtils
          .getTypeInfoFromObjectInspector(arguments[1]);
      ...
      if (oiTypeInfo0 != oiTypeInfo1) {
        ...
        if (oiTypeInfo0.equals(TypeInfoFactory.stringTypeInfo)
          ...
          compareOI = TypeInfoUtils
              .getStandardWritableObjectInspectorFromTypeInfo(TypeInfoFactory.doubleTypeInfo);
        } else {
          TypeInfo compareType = FunctionRegistry.getCommonClass(oiTypeInfo0,
              oiTypeInfo1);

          compareOI = TypeInfoUtils
              .getStandardWritableObjectInspectorFromTypeInfo((compareType == null) ? TypeInfoFactory.doubleTypeInfo
                  : compareType);
        }

        converter0 = ObjectInspectorConverters.getConverter(arguments[0],
            compareOI);
        converter1 = ObjectInspectorConverters.getConverter(arguments[1],
            compareOI);
      } else {
  ...
  public Integer compare(DeferredObject[] arguments) throws HiveException {
    ...
    if (compareType == CompareType.NEED_CONVERT) {
      ...
      return ObjectInspectorUtils.compare(converted_o0, compareOI,
          converted_o1, compareOI);
    } else {
      return ObjectInspectorUtils.compare(o0, argumentOIs[0], o1,
          argumentOIs[1]);
    }
  }
